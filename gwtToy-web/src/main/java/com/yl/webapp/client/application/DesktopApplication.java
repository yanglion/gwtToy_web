...
import com.yl.webapp.client.application.base.request.RequestEvent;
import com.yl.webapp.client.application.base.security.AuthRequiredEvent;
...
import com.yl.webapp.client.application.base.security.RequestForbidenEvent;
...
import com.yl.webapp.client.ui.Shell;
    ...
    protected void initHandlers() {
        ...
        RequestForbidenEvent.register(eventBus, new RequestForbidenEvent.Handler() {
            ...
            public void onRequestForbidenEvent(final RequestForbidenEvent requestForbidenEvent) {
                shell.addMessage(i18n._03_title(), AlertType.WARNING);
            }
        });
    }
