...
import com.yl.webapp.client.ui.navigation.NavigationBar;
import com.yl.webapp.client.ui.navigation.SideNavigationBar;
...
public class DesktopShell extends Shell implements LoginEvent.Handler, LogoutEvent.Handler, PlaceChangeEvent.Handler {
     ...
     */
    @Override
    public void addMessage(final Alert alert) {
        messages.add(alert);
        Window.scrollTo(0, 0);
    }
