 ...
 * 
 */
package com.yl.webapp.client.ui.login;
...
import com.yl.webapp.client.ui.login.LoginView.LoginDetails;
            ...
            requestBuilder.sendRequest(createLoginPostData(login), new RequestCallback() {
                ...
                public void onResponseReceived(final Request request, final Response response) {
                    ...
                    if (statusCode == Response.SC_OK) {
                        ...
                        view.setWaiting(false);
                        view.setMessage(new Alert(i18n.errors_password_mismatch(), AlertType.WARNING, false));
                    }
                    else {
        ...
        requests.userRequest().sendPasswordHint(login.getUsername()).fire(new Receiver<String>() {
            ...
            public void onSuccess(final String userEmail) {
                ...
                if (userEmail != null) {
                    ...
                    message = new Alert(i18n.login_passwordHint_error(username), AlertType.WARNING);
                }
                if (message != null) {
